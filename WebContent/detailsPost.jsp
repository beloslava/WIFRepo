			...
			<div class="right-content">
				...
				<div class="content">
					...
					<div class="box1">
						...
						<div class="blog-img">
							<div class="view-back">
								<span class="views" title="views">(566)</span> <span
									class="likes" title="likes"><%=post.getLike()%></span> <span
									class="link" title="link">(24)</span> <a href="#"> </a>
							</div>

...
<div class="wrapper">
  <div class="intro">Your world in frames... </div>
  <div class="blog-wrap">
    <div class="blog-grid">
    ...
    <c:forEach var='post' items='${PostDAO.getInstance().getAllPosts().values()}'>
     ...
     <div class="post format-image box">
        ...
        <div class="details"> 
	       ...
	       <span class="icon-artist"><a href="/details/profile?email=<c:out value="${post.userEmail}"></c:out>>" title="author name"><c:out value= "${userName}"></c:out></a></span> 

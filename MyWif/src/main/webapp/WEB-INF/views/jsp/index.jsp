	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="register" method="POST" class="registration-form" enctype="multipart/form-data">
				                        ...
				                        <div class="form-group">
				                        	...
				                        	<input type="password" name="password2" placeholder="Repeat password..." class="form-last-name form-control" id="form-password">
				                        </div>
				                        <div class="form-group">
				                        	<input type="file" name="fileField"class="form-file form-control" id="form-file">
				                        </div>

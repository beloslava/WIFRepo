			...
			<div id="menu-wrapper">
				<div id="menu" class="menu">
					<ul id="tiny">
						...
						<li><a href="myFollowedPosts">Feed</a></li>
	...
	<div class="wrapper">
		...
		<div class="box">
			...
			<div class="one-third">
				...
				<c:choose>
					<c:when
						test="${not UsersManager.getInstance().isUserFollowedByUser(user.email,
					sessionScope.USER)}">
						<form class="forms" action="follow" method="post">
							<fieldset>
								<ol>
									<li class="button-row"><input type="hidden"
					...
					<c:otherwise>
						<form class="forms" action="unfollow" method="post">
							<fieldset>
								<ol>
									<li class="button-row"><input type="hidden"
										value="<c:out value="${sessionScope.USER}"></c:out>">
				...
				<c:forEach var='followerEmail'
					items='${UsersManager.getInstance().getFollowersByUser(user.email)}'
					end="5">
					<c:set var="userName"
				...
				<c:forEach var='followedEmail'
					items='${UsersManager.getInstance().getFollowedByUser(user.email)}'
					end="5">
					<c:set var="userName"
			...
			<div class="two-third last">
				...
				<c:forEach var='post'
					items='${PostDAO.getInstance().getAllPostsByUser(param.email)}'>
